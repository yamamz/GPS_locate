...
public class TMCoordConverter {
    ...
    private double TranMerc_a = 6378206.4;              /* Semi-major axis of ellipsoid i meters */
    private double TranMerc_f = 0.00339007530392879;      /* Flattening of ellipsoid  */
    private double TranMerc_es = 0.006768658; /* Eccentricity (0.08181919084262188000) squared */
    private double TranMerc_ebs = 0.006814785;   /* Second Eccentricity squared */
   ...
   // 294.978700000
    ...
    private double TranMerc_Origin_Long =Math.toRadians(125.000);          /* Longitude of origin in radians */
    private double TranMerc_False_Northing = 0.0;       /* False northing in meters */
    private double TranMerc_False_Easting = 500000;        /* False easting in meters */
    private double TranMerc_Scale_Factor = 1.060020000000;         /* Scale factor  */
